        ...
        <form action="<?= base_url() ?>user/cekOngkir" method="post">
            <?php foreach ($products as $product) : ?>
                <div class="row detail-sepatu ">
                    <input type="checkbox" name="select-item[]" class="select-product" data-price="<?= $product['price'] ?>" data-amount="<?= $product['amount'] ?>" onclick="selectItem(this)" value="<?= $product['id'] ?>">
                    <div class="gambar">
